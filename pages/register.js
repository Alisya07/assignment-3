...
const Register = () => {
    ...
    return (
        <View style={loginStyle.container}>
            ...
            <View style={loginStyle.section}> 
                <Button style={{...loginStyle.buttonBox, width: 300, backgroundColor: '#ffe5ec'}} icon="account-check" mode="contained-tonal" onPress={() => console.log('REGISTER')}>Register</Button>
            </View>
